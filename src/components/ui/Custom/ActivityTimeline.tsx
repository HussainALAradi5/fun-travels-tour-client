...
import type { ActivityTimelineProps } from "@/interface/props/ui/ActivityTimelineProps";
...
export const ActivityTimeline = ({ items, initialVisibleMiddle = 1, animate = true }: ActivityTimelineProps) => {
