...
export const componentCatalog: ComponentShowcaseItem[] = [
  ...
  { id: 5, slug: "capacity-progress", name: "Capacity Progress", category: ComponentCategory.DATA_DISPLAY, description: "Capacity, percentage, and availability visualization.", importPath: "@/components/ui/Custom/CapacityProgress", features: ["Percentage", "Units", "Status text"] },
  ...
  { id: 9, slug: "date-picker", name: "Date Picker", category: ComponentCategory.FORM, description: "Single-date and date-range selection.", importPath: "@/components/ui/Custom/DatePicker", features: ["Date range", "Minimum date", "Month/year navigation"] },
